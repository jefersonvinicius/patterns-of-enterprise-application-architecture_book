...
describe('PersonMapper', async () => {
  ...
  it('should find person', async () => {
    ...
    expected.id = 1;
    expected.firstName = 'Jeferson';
    expected.lastName = 'Santos';
    expected.numberOfDependents = 6;
  ...
  it('should insert person', async () => {
    ...
    newPerson.firstName = 'Novo';
    newPerson.lastName = 'Silva';
    newPerson.numberOfDependents = 3;
