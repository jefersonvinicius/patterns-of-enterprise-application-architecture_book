...
export abstract class AbstractMapper {
  ...
  protected load<T>(resultSet: any): T {
    ...
    const object = this.createEmptyObject();
    object.id = id;
    this.doLoad<T>(object, resultSet);
  ...
  protected abstract doLoad<T>(object: DomainObject, resultSet: any): T;

  protected abstract insertStatement: string;

  protected abstract createEmptyObject(): DomainObject;
